                ...
                <Box sx={heroStack}>
                    <Stack direction={'column'} spacing={3} sx={{ height: '100%', maxWidth: '500px' }} justifyContent={'center'} alignItems={{ xs: "center" }}>
                        <Typography variant='h5' sx={{ fontWeight: 'bold', color: '#fff', textAlign: 'center' }}>
                            At Izafatech, we&apos;re dedicated to empowering tech enthusiasts of all ages to become digital superheroes.
                            <span style={{ color: '#d6fc3c' }}> &quot;Wow, I built that!&quot;</span>, we&apos;re here to ensure you don&apos;t just learn tech, but love it. Let&apos;s build amazing things and maybe break the internet (just a little)!
                        </Typography>
